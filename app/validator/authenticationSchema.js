...
const signUp = joi.object({
    ...
    userName: joi.string().pattern(/^[A-Za-z][\_\.]{3-20}$/).error(new Error("You must fill in the username field")),
    phoneNumber: joi.string().pattern(/^09[0-9]$/).error(new Error("your phone number is incorrect")),
